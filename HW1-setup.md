...
For this first assignment, I am providing you with a template.  The questions appear in *italics*, and your answers should be in non-italic text.  Future reports do not need to include the questions.
...
Before submitting your report, make sure to view your report file (generally named `HWx-report.md`) on GitHub to make sure that the formatting is done properly and all needed files have been included and all links in your report work as intended. 
...
* create a new repository (repo) in your account at GitHub.com and create two files that contain anything you want
...
What is the URL of the new GitHub repo that you created above?
...
Remove the outer parenthesis from the code above and run the cell.  What happened? (For an explanation, see [Breaking up long lines of code in Python](https://www.pythonmorsels.com/breaking-long-lines-code-python/))
...
Use the message "Ready to grade @weiglemc" as your final commit message.
